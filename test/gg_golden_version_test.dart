...
void main() {
  group('gg_golden_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_golden_version.dart');
